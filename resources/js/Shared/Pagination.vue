  ...
  <div v-if="links.length > 3">
    <div class="flex flex-wrap -mb-1">
      <template v-for="(link, key) in links">
        ...
        <Link v-else
              :key="`link-${key}`"
              class="mb-1 mr-1 px-4 py-3 focus:text-main-500 text-sm leading-4  border focus:border-blue-500 rounded"
              :class="{
                'bg-main-600 hover:bg-main-400 text-white': link.active,
